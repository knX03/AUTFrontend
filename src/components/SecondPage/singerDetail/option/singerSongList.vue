...
<template>
  <div class="songList_mod" v-if="singerSongExist">
  ...
  <div class="singerSongNull_mod" v-if="!singerSongExist">
...
.singerSongNull_mod svg {
  width: 300px;
  height: 300px;
}

.singerSongNull_mod span {
  font-family: STXihei, serif;
  font-size: 15px;
  font-weight: 900;
}
